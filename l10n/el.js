OC.L10N.register(
    ...
    "Upload new files via drag and drop or by using the [+] button above" : "Μεταφορτώστε νέα αρχεία με μεταφορά και απόθεση ή με το κουμπι [+] παραπάνω",
    ...
    "Media gallery for Nextcloud" : "Συλλογή πολυμέσων του Nextcloud",
    "Media gallery for Nextcloud with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" or \".noimage\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Γκαλερί μέσων για το Nextcloud με τις ακόλουθες δυνατότητες:\n\n\t\t- Υποστήριξη για μεγάλη επιλογή τύπων μέσων (ανάλογα με τη ρύθμιση του διακομιστή)\n\n\t\t- Μεταφορτώστε και οργανώστε εικόνες και άλμπουμ απευθείας από την εφαρμογή\n\n\t\t- Μεγάλες, με δυνατότητα μεγέθυνσης προεπισκοπήσεις, οι οποίες μπορούν να προβληθούν σε λειτουργία πλήρους οθόνης\n\n\t\t- Ταξινόμηση εικόνων με το όνομα ή την ημερομηνία\n\n\t\t- Σχεδιασμός ανά άλμπουμ, περιγραφή και δήλωση πνευματικών δικαιωμάτων\n\n\t\t- Στάνταρ δυνατότητες (εξωτερικά κοινόχρηστα, browser svg απόδοση, κ.α.)\n\n\t\t-Λήψη εικόνας απευθείας από τη παρουσίαση ή τη συλλογή\n\n\t\t- Μεταβείτε στη Γκαλερί από οποιοδήποτε φάκελο σε αρχεία και αντίστροφα\n\n\t\t- Αγνοήστε τους φακέλους που περιέχουν ένα αρχείο \".nomedia\" ή \".noimage\"\n\n\t\t- Απόδοση προγράμματος περιήγησης των εικόνων SVG (απενεργοποιημένη από προεπιλογή)\n\n\t\t- Native SVG υποστήριξη\n\n\t\t- Υποστήριξη για κινητά\n\t\tΠαρέχει μια αποκλειστική προβολή όλων των εικόνων σε ένα πλέγμα, προσθέτει δυνατότητες προβολής εικόνων στην\n\t\tεφαρμογή και προσθέτει προβολή γκαλερί στους δημόσιους συνδέσμους.\n\t\tΣυμβατό με Firefox, Chrome και Internet Explorer 11",
    ...
    "Media gallery for Nextcloud with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Γκαλερί μέσων για το Nextcloud με τις ακόλουθες δυνατότητες:\n\n\t\t- Υποστήριξη για μεγάλη επιλογή τύπων μέσων (ανάλογα με τη ρύθμιση του διακομιστή)\n\n\t\t- Μεταφορτώστε και οργανώστε εικόνες και άλμπουμ απευθείας από την εφαρμογή\n\n\t\t- Μεγάλες, με δυνατότητα μεγέθυνσης προεπισκοπήσεις, οι οποίες μπορούν να προβληθούν σε λειτουργία πλήρους οθόνης\n\n\t\t- Ταξινόμηση εικόνων με το όνομα ή την ημερομηνία\n\n\t\t- Σχεδιασμός ανά άλμπουμ, περιγραφή και δήλωση πνευματικών δικαιωμάτων\n\n\t\t- Στάνταρ δυνατότητες (εξωτερικά κοινόχρηστα, browser svg απόδοση, κ.α.)\n\n\t\t-Λήψη εικόνας απευθείας από τη παρουσίαση ή τη συλλογή\n\n\t\t- Μεταβείτε στη Γκαλερί από οποιοδήποτε φάκελο σε αρχεία και αντίστροφα\n\n\t\t- Αγνοήστε τους φακέλους που περιέχουν ένα αρχείο \".nomedia\"\n\n\t\t- Απόδοση προγράμματος περιήγησης των εικόνων SVG (απενεργοποιημένη από προεπιλογή)\n\n\t\t- Native SVG υποστήριξη\n\n\t\t- Υποστήριξη για κινητά\n\t\tΠαρέχει μια αποκλειστική προβολή όλων των εικόνων σε ένα πλέγμα, προσθέτει δυνατότητες προβολής εικόνων στην\n\t\tεφαρμογή και προσθέτει προβολή γκαλερί στους δημόσιους συνδέσμους.\n\t\tΣυμβατό με Firefox, Chrome και Internet Explorer 11"
},
