OC.L10N.register(
    ...
    "Upload new files via drag and drop or by using the [+] button above" : "Μεταφόρτωση νέων αρχείων με μεταφορά και απόθεση ή με την χρήση του κουμπιού [+]",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Σφάλμα!</strong> Αδυναμία δημιουργίας προεπισκόπισης αυτού του αρχείου.<br>Παρακαλώ μετακινηθείτε στην επόμενη διαφάνεια ενώ εμείς αφαιρούμε αυτήν την εικόνα από την παρουσίαση",
    "Next" : "Επόμενο",
    "Play" : "Αναπαραγωγή",
    "Pause" : "Παύση",
    ...
    "Error while retrieving shares" : "Σφάλμα κατά την ανάκτηση κοινόχρηστων φακέλων",
