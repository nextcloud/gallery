OC.L10N.register(
    ...
    "I am sorry, but I could not find any media files at this location." : "Λυπάμαι αλλά δεν μπόρεσα να βρω αρχεία πολυμέσων σε αυτή την τοποθεσία.",
    ...
    "<strong>Error!</strong> Your browser can't display SVG files.<br>" : "<strong>Σφάλμα!</strong> Ο περιηγητής σας δεν υποστηρίζει αρχεία SVG.<br>",
    "Next" : "Επόμενο",
    "Play" : "Αναπαραγωγή",
    "Pause" : "Παύση",
