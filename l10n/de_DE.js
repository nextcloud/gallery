OC.L10N.register(
    ...
    "Could not move \"{file}\", target exists" : "Die Datei \"{file}\" konnte nicht verschoben werden, da die Datei im Zielordner bereits existiert",
    "Could not move \"{file}\"" : "Die Datei \"{file}\" konnte nicht verschoben werden ",
    ...
    "Gallery view" : "Galerie-Ansicht",
    "Could not load the description" : "Die Beschreibung konnte nicht geladen werden",
    "Could not load the description: " : "Die Beschreibung konnte nicht geladen werden:",
    "Copyright" : "Urheberrecht",
    "Could not load the copyright notice: " : "Der Urheberrechts-Hinweis konnte nicht geladen werden:",
    "Copyright notice" : "Urheberrechts-Text",
    "Link to copyright document" : "Link zum Uhrheberrechts-Dokument",
    ...
    "Upload pictures in the files app to display them here" : "Laden Sie Bilder in der Dateien-App hoch, damit sie hier angezeigt werden.",
    ...
    "Possible reasons for the problem:" : "Möglicher Grund für dieses Problem:",
    "a conflicting app was installed" : "eine widerstreitende App wurde installiert",
