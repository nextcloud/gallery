OC.L10N.register(
    ...
    {
    "Gallery" : "Galerija",
    "There was a problem reading files from this album" : "Radās problēma nolasot failus no šī albuma",
    "Aborting preview. Could not find the file" : "Pārtrauc priekšskatījumu. Nevarēja atrast failu",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Kļūda!</strong> Nevarēja izveidot faila priekšskatījumu.<br>Lūdzu, pārejiet uz nākamo slaidu, kamēr mēs noņemt šo attēlu no slaidrādes",
    "Next" : "Nākamā",
    "Play" : "Atskaņot",
    "Pause" : "Pauzēt",
    ...
    "For more information, please contact your friendly ownCloud administrator." : "Plašākai informācijai, lūdzu, sazinieties ar draudzīgo administratoru.",
