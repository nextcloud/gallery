OC.L10N.register(
    ...
    "This application may not work properly on your browser." : "Může se stát, že tato aplikace nebude ve vámi používaném prohlížeči fungovat, jak má.",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Chyba!</strong> Náhled tohoto souboru nelze vytvořit.<br>Přejděte prosím na následující položku a tento obrázek bude odstraněn z promítání",
    "Next" : "Následující",
    "Play" : "Přehrát",
    "Pause" : "Pozastavit",
    "Previous" : "Předchozí",
    ...
    "The public link will expire no later than {days} days after it is created" : "Platnost veřejného odkazu skončí nejpozději {days} dní od jeho vytvoření",
    "Link" : "Odkaz",
    ...
    "No users or groups found for {search}" : "Nenalezeni žádní členové ani skupiny pro {search}",
    "No users found for {search}" : "Nenalezeni žádní uživatelé pro {search}",
    ...
    "For more information, please contact your friendly Nextcloud administrator." : "Pokud chcete vědět víc, obraťte se na správce vašeho Nextcloud.",
