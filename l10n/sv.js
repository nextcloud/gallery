OC.L10N.register(
    ...
    "Could not load the description" : "Kunde inte Läs in beskrivningen",
    "Could not load the description: " : "Kunde inte Läs in beskrivningen:",
    "Copyright" : "Copyright",
    "Could not load the copyright notice: " : "Kunde inte Läs in Copyright notis:",
    ...
    "For an improved experience, please install one of the following alternatives" : "För en förbättrad upplevelse, vänligen installera ett av följande alternativ",
    "Your browser is not supported!" : "Din webbläsare stöds inte!",
    "please install one of the following alternatives" : "Vänligen installera ett av följande alternativ",
    "Album cannot be shown" : "Album kan inte visas",
    ...
    "For more information, please contact your friendly Nextcloud administrator." : "För mer information vänligen kontakta din administratör.",
    ...
    "the filesystem is not readable" : "filsystemet är inte läsbart",
    ...
    "For more information, please ask the person who has sent you this link." : "För mer information, vänligen fråga personen som skickat dig länken",
    "Picture view" : "Bildvy",
    "Media gallery for Nextcloud with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Mediagalleri för Nextcloud med följande funktioner:\n\n\t\t- Stöd för stort urval av medietyper (beroende på serverinställningar)\n\n\t\t- Ladda upp och organisera bilder och album direkt från appen\n\n\t\t- Stora, zoombara förhandsvisningar som kan visas i fullskärmsläge\n\n\t\t- Sortera bilder efter namn eller datum\n\n\t\t- Per albumdesign, beskrivning och upphovsrätt\n\n\t\t- A la carte-funktioner (externa delningar, webbläsartolkning av svg, o.s.v.)\n\n\t\t- Bildhämtning direkt från bildspelet eller galleriet\n\n\t\t- Växla till Galleri från valfri mapp i filer och vice versa\n\n\t\t- Ignorera mappar som innehåller en \".nomedia\"-fil\n\n\t\t- Webbläsartolkning av SVG-bilder (inaktiverad som standard)\n\n\t\t- Lokalt stöd för SVG\n\n\t\t- Mobilt stöd\n\n\t\tGer en dedikerad bild av alla bilder i ett rutnät, lägger bildvisning kapacitet till\n\t\tappen filer och lägger till en gallerivy till offentliga länkar.\n\t\tKompatibel med Firefox, Chrome och Internet Explorer 11"
},
