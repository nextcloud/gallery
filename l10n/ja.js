OC.L10N.register(
    ...
    "New" : "新規作成",
    "Share with people on other servers using their Federated Cloud ID username@example.com/cloud" : "クラウド共有ID （ username@example.com/cloud ） を使用して他のサーバー上のユーザーと共有する",
