OC.L10N.register(
    ...
    "Error while unsharing" : "Błąd podczas zatrzymywania udostępniania",
    ...
    "Share with users, groups or remote users …" : "Udostępnij użytkownikom, grupom lub użytkownikom zdalnym…",
    ...
    "Media gallery for Nextcloud with the following features:\n\n\t\t- Support for large selection of media types (depending on server setup)\n\n\t\t- Upload and organise images and albums straight from the app\n\n\t\t- Large, zoomable previews which can be shown in fullscreen mode\n\n\t\t- Sort images by name or date\n\n\t\t- Per album design, description and copyright statement\n\n\t\t- A la carte features (external shares, browser svg rendering, etc.)\n\n\t\t- Image download straight from the slideshow or the gallery\n\n\t\t- Switch to Gallery from any folder in files and vice-versa\n\n\t\t- Ignore folders containing a \".nomedia\" or \".noimage\" file\n\n\t\t- Browser rendering of SVG images (disabled by default)\n\n\t\t- Native SVG support\n\n\t\t- Mobile support\n\n\t\tProvides a dedicated view of all images in a grid, adds image viewing capabilities to the\n\t\tfiles app and adds a gallery view to public links.\n\t\tCompatible with Firefox, Chrome and Internet Explorer 11" : "Galeria multimediów dla Nextcloud z następującymi funkcjami:\n\n\t\t- Obsługa dużego wyboru typów nośników (w zależności od konfiguracji serwera)\n\n\t\t- Przesyłaj i organizuj zdjęcia i albumy bezpośrednio z aplikacji\n\n\t\t- Duże, powiększone podglądy, które można wyświetlać w trybie pełnoekranowym\n\n\t\t- Sortuj zdjęcia według nazwy lub daty\n\n\t\t- Na projekcie albumu, opis i oświadczenie o prawach autorskich\n\n\t\t- Funkcje a la carte (akcje zewnętrzne, przeglądanie svg w przeglądarce itp.)\n\n\t\t- Pobieranie obrazu bezpośrednio z pokazu slajdów lub galerii\n\n\t\t- Przełącz się do Galerii z dowolnego katalogu plików i odwrotnie\n\n\t\t- Ignoruj katalogi zawierające plik „.nomedia” lub „.noimage”\n\n\t\t- Renderowanie przeglądarki obrazów SVG (domyślnie wyłączone)\n\n\t\t- Natywna obsługa SVG\n\n\t\t- Wsparcie mobilne\n\n\t\tZapewnia dedykowany widok wszystkich obrazów w siatce, dodaje możliwości przeglądania obrazów dla\n\t\taplikacji plików i dodaje widok galerii dla linków publicznych.\n\t\tKompatybilny z Firefox, Chrome i Internet Explorer 11",
    ...
    "For more information, please contact your friendly Nextcloud administrator." : "Skontaktuj się ze swoim administratorem Nextcloud, żeby uzyskać więcej informacji.",
