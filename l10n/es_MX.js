OC.L10N.register(
    ...
    "Could not load the copyright notice: " : "No se pudo cargar el aviso de derechos de autor:",
    ...
    "Upload pictures in the files app to display them here" : "Cargue imágenes en la aplicación de archivos para desplegarlas aqui",
    ...
    "Could not hide album" : "No se pudo ocultar el álbum",
    "Error loading slideshow template" : "Se presentó un error al cargar la plantilla de presentación",
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>¡Error!</strong> No se pudo generar la previsualización de este archivo. <br>Favor de ir a la siguiente imagen mientras quitamos esta del carrusel ",
    "Next" : "Siguiente",
    "Play" : "Reproducir",
    "Pause" : "Pausar",
    "Previous" : "Anterior",
    ...
    "The public link will expire no later than {days} days after it is created" : "La liga pública expirará en  {days} días después de haber sido creada",
    "Link" : "Liga",
    ...
    "group" : "grupo",
    "remote" : "remoto",
    "Resharing is not allowed" : "No se permite volver compartir",
    ...
    "Error unsetting expiration date" : "Se presentó un error al quitar la fecha de caducidad",
    "Error setting expiration date" : "Se presentó un error al establecer fecha de caducidad",
    "Sending ..." : "Enviando...",
    ...
    "Sorry, this file could not be found." : "Lo sentimos, este archivo no pudo ser encontrado. ",
    ...
    "Here is the error message returned by the server: " : "Aqui está el mensaje de error que regresó el servidor:",
    "For more information, please contact your friendly Nextcloud administrator." : "Para mayor información, favor de contactar a su cordial administrador de Nextcloud. ",
    ...
    "For more information, please ask the person who has sent you this link." : "Para mayor información, favor de consultar a la persona que le envió esta liga.",
