OC.L10N.register(
    ...
    "Could not load the description: " : "无法载入描述",
    "Copyright" : "版权",
    "Could not load the copyright notice: " : "无法加载版权声明：",
    "Copyright notice" : "版权声明",
    "Link to copyright document" : "链接到版权文档",
    "This application may not work properly on your browser." : "该应用可能无法在您的浏览器内正常运行",
    "For an improved experience, please install one of the following alternatives" : "为了获得更好的体验，请安装以下替代方法之一",
    "Your browser is not supported!" : "您的浏览器对此不支持！",
    "please install one of the following alternatives" : "请安装以下替代方法之一",
    "Album cannot be shown" : "相册无法显示",
    "No media files found" : "未找到媒体文件",
    "Upload pictures in the Files app to display them here" : "在 “文件” 应用中上传图片以在此处显示",
    ...
    "Share link" : "共享链接",
    "The public link will expire no later than {days} days after it is created" : "这个共享链接将在创建 {days} 天后失效",
    "Link" : "链接",
